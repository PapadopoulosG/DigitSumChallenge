...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sumDigits(-1));
        System.out.println(sumDigits(152556));

    }

    /**
     * Receives a number and calculates the sum of all it's digits.
     * Does not accept numbers <10
     * @param number Number to get sum of.
     * @return sum The sum of digits for the number it was called.
     */
